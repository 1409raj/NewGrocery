...
public class UserController {
	...
	public @ResponseBody ResponseEntity<Domain<List<UsersEntity>>> getProductByCategoryName(
	...
	public @ResponseBody ResponseEntity<Domain<String>> savecustomerForMerchant(
			@RequestParam("merchantid") Integer merchantId, @RequestParam("customerid") Integer customerid,
	...
	public @ResponseBody ResponseEntity<Domain<List<CustomerMerchantEntity>>> getConnectedCustomerlistforMerchant(
	...
	public @ResponseBody ResponseEntity<Domain<List<CustomerMerchantEntity>>> getPendingCustomerlistforMerchant(
			@RequestParam("merchantid") String merchantid) {
		Domain<List<CustomerMerchantEntity>> entity = userService
				.getPendingCustomerMerchnat(Integer.parseInt(merchantid));
		return new ResponseEntity<Domain<List<CustomerMerchantEntity>>>(entity, HttpStatus.OK);
	}

	@RequestMapping(value = "/getConnectedMerchantlistforCustomer", method = RequestMethod.POST)
	public @ResponseBody ResponseEntity<Domain<List<CustomerMerchantEntity>>> getConnectedMerchantlistforCustomer(
	...
	public @ResponseBody ResponseEntity<Domain<List<CustomerMerchantEntity>>> getCustomerlistforMerchant(
			@RequestParam("customerid") String customerid) {
		Domain<List<CustomerMerchantEntity>> entity = userService
				.getPendingMerchnatCustomer(Integer.parseInt(customerid));
		return new ResponseEntity<Domain<List<CustomerMerchantEntity>>>(entity, HttpStatus.OK);
	}
	...
	public @ResponseBody ResponseEntity<Domain<String>> deleteImage(@RequestParam("userid") Integer userid,
	...
	public @ResponseBody ResponseEntity<Domain<List<UsersEntity>>> getUsersearch(
			@RequestParam("usersearch") String usersearch, @RequestParam("roleid") String roleid,
	...
	public @ResponseBody ResponseEntity<Domain<String>> updateCustomerMerchantSatus(@RequestParam("rowid") String id,
	...
	public @ResponseBody ResponseEntity<Domain<String>> updateCMWallet(@RequestParam("rowid") String id,
